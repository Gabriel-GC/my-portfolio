const messages = {
    ...
    en: {
        translations: {
            ...
            navbar:{
                privateContact:'PARTICULAR CONTACT',
                home:'Home',
                about: 'About',
                skills: 'Skills',
                projects: 'Projects',
            ...
            projects:{
                project:'PROJECTS',
                development:'Developments and participations',
                seemore:'View more',
                modal_button:'Close',
                modal_warning:'The site may not be available due to client administration. Updated on 2022-07-04*'
            },
